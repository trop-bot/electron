...
void AllowGuestViewElementDefinition(v8::Isolate* isolate,
  ...
  GetRenderFrame(window)->GetWebFrame()->RequestExecuteV8Function(
...
v8::Local<v8::Value> GetParent(v8::Isolate* isolate,
                               v8::Local<v8::Value> window) {
